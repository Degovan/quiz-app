                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_hp" id="no_hp" class="form-control" placeholder="Tuliskan NO HP untuk user....." value="{{ old("no_hp") ?? $user->no_hp }}">
                            @error('no_hp')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="wilayah" id="wilayah" class="form-control" placeholder="Tuliskan wilayah untuk user....." value="{{ old("wilayah") ?? $user->wilayah }}">
                            @error('wilayah')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
